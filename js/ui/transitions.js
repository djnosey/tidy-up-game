...
import { drawBossBody, drawBossEyes } from '../engine/renderers/boss-renderer.js';
import { OPENING_STORY, LEVEL_INTROS, BOSS_INTROS } from '../data/story-data.js';
...
export class TransitionManager {
    ...
    _renderBoss(ctx, w, h) {
        ...
        if (this.timer > 0.3 && d.bossConfig) {
            ...
            // Draw the boss body and eyes using the boss renderer
            drawBossBody(ctx, boss, sx, sy, cx, cy, bossW, bossH, d.bossConfig.color);
            drawBossEyes(ctx, boss, cx, cy, bossW, bossH);
